 ...
 */
package src.main.java.com.vgorcinschi.assignmentone.utils;
...
public class NumberFormatter {
    ...
    public static Double validateDoubleValue(String type, int precision,
            Scanner sc) {
        boolean responseReady = false;
        double response = 0;
        System.out.println("Please enter the " + type + " value:");
        while (responseReady == false) {
            try {
                ...
                log.error("An invalid double input has been provided while asking for " + type + ": "
                        + e.getMessage());
